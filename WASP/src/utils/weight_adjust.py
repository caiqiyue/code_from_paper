...
def weight_decay_qa(args, current_outer_iter_trained_model, train_data, theta_mapped, beta, _type="none", single_dataset=False, use_soft_label=False, num_models=-1):
