...
LOGDIR="$ROOT/logs"
SUMMARY="$LOGDIR/round181_diagnostic_batch_summary.tsv"
MASTER="$LOGDIR/round181_diagnostic_batch_master.log"
...
declare -a CONFIGS=(
  ...
  "configs/experiments/single_node_tuning_round181/diagnostics/r181_congressional_g2.yaml"
  "configs/experiments/single_node_tuning_round181/diagnostics/r181_congressional_g3.yaml"
  "configs/experiments/single_node_tuning_round181/guard/r181_forums_g1.yaml"
  "configs/experiments/single_node_tuning_round181/guard/r181_forums_g2.yaml"
)

declare -a EXPS=(
  "r181_congressional_g1"
  "r181_congressional_g2"
  "r181_congressional_g3"
  "r181_forums_g1"
  "r181_forums_g2"
)
...
echo "$(date '+%F %T') Round18.1 diagnostic batch done" | tee -a "$MASTER"
