"""Legacy DistilGPT2 evaluation entry point kept as a thin wrapper."""
...
def parse_args() -> argparse.Namespace:
    """Parse the original DistilGPT2 evaluation CLI arguments."""
...
def main() -> None:
    """Translate the legacy arguments to the new config-driven DistilGPT2 runner."""

    args = parse_args()
    del args.cachedir
    config = build_legacy_config(args, base_dir=Path(__file__).resolve().parent, stage="eval_small")
    summary = run_eval_small(config)
