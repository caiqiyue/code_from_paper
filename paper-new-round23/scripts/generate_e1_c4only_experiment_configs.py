#!/usr/bin/env python3
"""Generate E1 C4-only baseline experiment configs and manifests.

Each emitted config inherits the round23 dynamic base (which in turn inherits
round19's formal selector base for downstream eval params), then overrides
the pipeline mode to ``c4_only`` so round19's existing C4 sampling path is used.
"""
...
MODE_SPECS = {
    "e1_c4only_seen_smoke": {
        "subdir": "e1_c4only_seen_smoke",
        "manifest_name": "round23_e1_c4only_seen_smoke_manifest.tsv",
        "datasets": SEEN_DATASETS,
        "seeds": SEEDS_SMOKE,
        "experiment_prefix": "e1_c4only_smoke",
        "source_env": "e1_c4only_seen_smoke",
        "output_root_prefix": "outputs/e1_c4only_seen_smoke",
    },
    "e1_c4only_seen_repeat30": {
        "subdir": "e1_c4only_seen_repeat30",
        "manifest_name": "round23_e1_c4only_seen_repeat30_manifest.tsv",
        "datasets": SEEN_DATASETS,
        "seeds": SEEDS_REPEAT30,
        "experiment_prefix": "e1_c4only",
        "source_env": "e1_c4only_seen_repeat30",
        "output_root_prefix": "outputs/e1_c4only_seen_repeat30",
    },
    "e1_c4only_all6_smoke": {
        "subdir": "e1_c4only_all6_smoke",
        "manifest_name": "round23_e1_c4only_all6_smoke_manifest.tsv",
        "datasets": ALL6_DATASETS,
        "seeds": SEEDS_SMOKE,
        "experiment_prefix": "e1_c4only_smoke",
        "source_env": "e1_c4only_all6_smoke",
        "output_root_prefix": "outputs/e1_c4only_all6_smoke",
    },
    "e1_c4only_all6_repeat6": {
        "subdir": "e1_c4only_all6_repeat6",
        "manifest_name": "round23_e1_c4only_all6_repeat6_manifest.tsv",
        "datasets": ALL6_DATASETS,
        "seeds": SEEDS_REPEAT6,
        "experiment_prefix": "e1_c4only",
        "source_env": "e1_c4only_all6_repeat6",
        "output_root_prefix": "outputs/e1_c4only_all6_repeat6",
    },
}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate E1 C4-only experiment configs and manifests")
    parser.add_argument(
        "--mode",
        action="append",
    ...
    print("Generated C4-only configs under:", CONFIG_ROOT)
