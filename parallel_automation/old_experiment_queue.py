...
STATE_PATH = ROOT / "parallel_automation" / "parallel_experiment_queue_state.json"
LOG_PATH = ROOT / "parallel_automation" / "parallel_experiment_queue.log"
...
REMOTE_AUTOMATION = f"{REMOTE_REPO}/parallel_automation"
