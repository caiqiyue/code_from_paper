#!/usr/bin/env python3
"""Run PT-2 (validate_jobs_tiny_thesis_platform) on server."""
import subprocess
import os
import tempfile
...
Write-Host "=== Running PT-2 (validate_jobs_tiny_thesis_platform) ==="
...
if ($sshResult -match "metrics_summary.json") {
    ...
    Write-Host ""
    Write-Host "=== PT-2: Output unclear, check manually ==="
}
'''

ps1_path = os.path.join(tempfile.gettempdir(), 'run_pt2.ps1')
