#!/usr/bin/env python3
"""Upload updated llama2_eval.py via SCP."""
import subprocess
import base64
import os
import tempfile
...
decode_cmd = [
    ...
    f'base64 -d < {REMOTE_PATH}.b64 > {REMOTE_PATH} && echo DECODE_OK'
]
...
verify_cmd = [
    ...
    '-o', 'StrictHostKeyChecking=no', '-p', '26732',
    'root@connect.nmb1.seetacloud.com',
    f'python -c "import py_compile; py_compile.compile(\\"{REMOTE_PATH}\\", \\"{REMOTE_PATH}c\\")" 2>&1 && echo SYNTAX_OK'
]
