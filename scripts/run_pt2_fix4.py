...
ps1_path = os.path.join(tempfile.gettempdir(), 'run_pt2_fix4.ps1')
with open(ps1_path, 'w', encoding='utf-8') as f:
    f.write(ps_script)

# First copy the file to C:\temp\llama2_eval.py
import shutil
shutil.copy('/tmp/llama2_eval.py', 'C:/temp/llama2_eval.py')
