...
class DataInfScorer:
    """Research-mode influence scorer built on top of a frozen-embedding linear probe."""
    ...
    def score(self, samples, client_ctx):
        """Score synthetic samples against the client's probe-defined validation objective."""
        ...
        for feature in sample_aug:
            ...
            influence = -float(gradient @ bundle.h_inv @ bundle.val_gradient)
