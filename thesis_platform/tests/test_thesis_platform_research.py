...
class ResearchModeTests(unittest.TestCase):
    ...
    def test_dbscan_tsgdm_updates_memory(self) -> None:
        ...
        critiques_round_1 = [
            Critique("c1", "client_0", 0, "bad_0", ["real_0"], ["Add clinical terminology."], "Add clinical terminology.", {"source_score": 1.0}),
            Critique("c2", "client_1", 0, "bad_1", ["real_1"], ["Add clinical terminology."], "Add clinical terminology.", {"source_score": 1.2}),
        ]
        update_1 = aggregator.aggregate(critiques_round_1, server_ctx)
        self.assertTrue(update_1 is not None and update_1.rules)

        critiques_round_2 = [
            Critique("c3", "client_0", 1, "bad_2", ["real_2"], ["Add clinical terminology."], "Add clinical terminology.", {"source_score": 1.1}),
            Critique("c4", "client_1", 1, "bad_3", ["real_3"], ["Tighten medical specificity."], "Tighten medical specificity.", {"source_score": 0.9}),
        ]
