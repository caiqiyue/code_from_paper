...
class UncertaintyArbitrationTests(unittest.TestCase):
    ...
    def test_uses_stability_when_coverage_and_support_are_close(self):
        broad = {
            "policy_name": "broad_tail",
            "resolved_seed_top_k": 22,
            "coverage_p25": 0.9100,
            "coverage_mean": 0.9510,
            "support_mean": 0.7100,
            "stability_score": 0.0120,
        }
        compact = {
            "policy_name": "compact_structured",
            "resolved_seed_top_k": 19,
        ...
        self.assertEqual(selected["resolved_seed_top_k"], 19)
        self.assertEqual(selected["arbitration_winner_policy"], "compact_structured")
        self.assertEqual(selected["arbitration_reason"], "stability")
    ...
    def test_missing_stability_falls_back_to_compactness_tiebreak(self):
        broad = {
            "policy_name": "broad_tail",
            "resolved_seed_top_k": 22,
            "coverage_p25": 0.910,
