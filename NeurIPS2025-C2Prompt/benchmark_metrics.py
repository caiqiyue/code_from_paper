...
parser.add_argument("--log_path", type=str, required=True, help="result path")
args = parser.parse_args()

pathes = [args.log_path]  
...
def forward_transfer():
    forward_list = []
    forward_list_list = []
    if len(pathes_notran)==0:
        print("pathes_notran is empty, escape forward-transfer evaluation.")
...
def backward_transfer():
    ...
    if len(backward_list)==0:
        print("backward_list is empty, escape backward-transfer evaluation.")
